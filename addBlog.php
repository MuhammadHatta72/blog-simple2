...
<head>
    ...
    <title>Tambah Blog - Rania Rahmi Blog</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <form action="./addBlogAction.php" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input type="hidden" name="author" value="<?= $queryUser['first_name']; ?> <?= $queryUser['last_name']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" rows="3" placeholder="Isi Blog" required></textarea>
                                        </div>
                                        <div class="form-group">
