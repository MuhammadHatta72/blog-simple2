                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-warning">
                                ...
                                <form action="./editBlogAction.php" method="POST" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <input type="hidden" name="id" value="<?= $row['id_blog']; ?>">
                                            <label for="title">Judul Blog</label>
                                            <input type="text" name="title" class="form-control" id="title" placeholder="Judul Blog" value="<?= $row['title']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="description">Isi Blog</label>
                                            <textarea class="form-control" name="description" rows="3" placeholder="Isi Blog" required><?= $row['description']; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="picture_new">Update Gambar</label>
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="hidden" name="picture" value="<?= $row["picture"]; ?>">
                                                    <input type="file" name="picture_new" class="custom-file-input" id="picture_new">
                                                    <label class="custom-file-label" for="picture_new">Choose file</label>
                                                </div>
                                                <div class="input-group-append">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="./blogs.php" class="btn btn-default">Kembali</a>
