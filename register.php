...
<head>
    ...
    <title>Register - Rania Rahmi Blog</title>
    ...
    <div class="login-box">
        <div class="card card-outline card-warning">
            <div class="card-header text-center">
                <a href="#" class="h1 text-info"><b class="text-warning">Rania</b> Rahmi</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Sign in to start your register</p>
