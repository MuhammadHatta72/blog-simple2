...
<head>
    ...
    <title>Edit User - Rania Rahmi Blog</title>
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <?php
                                        if ($row["picture_profile"] == 'Belum Ditambahkan') {
                                        ...
                                        ?>
                                            ...
                                            ?>
                                            <img src="dist/img/users/<?= $row['picture_profile']; ?>" style="width: 100%;" alt="User Image">
                                        <?php
                                        }
                                        ?>
                                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="form-horizontal" method="POST" action="editUserAction.php">
                                    <input type="hidden" name="id" value="<?= $row['id_user']; ?>">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="first_name" class="col-sm-2 col-form-label">Nama Depan</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Nama Depan" value="<?= $row['first_name']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="last_name" class="col-sm-2 col-form-label">Nama Belakang</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Nama Belakang" value="<?= $row['last_name']; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="custom-select" id="gender" name="gender" required>
                                                    ...
                                                    <option <?= $row['gender'] == "Laki-laki" ? "selected" : ""; ?> value="Laki-laki">Laki-laki</option>
                                                    <option <?= $row['gender'] == "Perempuan" ? "selected" : ""; ?> value="Perempuan">Perempuan</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-footer">
                                        <a href="./users.php" class="btn btn-default">Kembali</a>
